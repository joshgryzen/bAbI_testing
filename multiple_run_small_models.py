...
# No Context
os.system('python predict.py --m=facebook/opt-350m --t=qa2_two-supporting-facts_train.txt')
os.system('python predict.py --m=facebook/opt-1.3b --t=qa2_two-supporting-facts_train.txt')
os.system('python predict.py --m=facebook/opt-2.7b --t=qa2_two-supporting-facts_train.txt')
# With Context
os.system('python predict.py --m=facebook/opt-350m --t=qa2_two-supporting-facts_train.txt --context')
os.system('python predict.py --m=facebook/opt-1.3b --t=qa2_two-supporting-facts_train.txt --context')
os.system('python predict.py --m=facebook/opt-2.7b --t=qa2_two-supporting-facts_train.txt --context')
