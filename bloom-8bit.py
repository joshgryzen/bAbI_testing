...
model = BloomForCausalLM.from_pretrained(
    "joaoalvarenga/bloom-8bit", low_cpu_mem_usage=True
)
tokenizer = BloomTokenizerFast.from_pretrained("joaoalvarenga/bloom-8bit")

prompt = tokenizer(
    "Given a table named salaries and columns id, created_at, salary, age. Creates a SQL to answer What is the average salary for 22 years old:",
    return_tensors="pt",
)
